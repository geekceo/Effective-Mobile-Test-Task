import json
from Tutter.perks import Header, tutstr
from typing import Union, get_args, Callable
...
class BaseModel(object):
    ...
    '''
        ...
        For file params needs to send tuple arg - Ex. file=('data.txt', ' = ')
            If json file you need to send file = ('data.json', 'json')
    '''
    ...
    def __validators_handler(self):

        validators = [name for name in dir(self) if 'validator_' in name]
